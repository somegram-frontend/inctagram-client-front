...
const appDeploy = 'http://localhost:3000/auth/createNewPassword/##token##' //TODO change to deploy-app-path, when finish develop
// const appDeploy = 'https:// ... .app/new-password/##token##'
